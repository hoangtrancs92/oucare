...
public class BookingController  implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            ...
            this.userComboBox.setItems(FXCollections.observableList(Dc.getDoctor_create(idphongban)));
        ...
        departmentComboBox.setButtonCell(new ListCell<department>(){
            ...
            protected void updateItem(department item, boolean btl){
                ...
                if(item != null) {
                    ...
                    System.err.println(idphongban);
                    try {
                        userComboBox.setItems(FXCollections.observableList(Dc.getDoctor_create(idphongban)));
                        bookingBtn.setDisable(true);
